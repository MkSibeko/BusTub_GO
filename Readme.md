...
│   │   ├── config.go            # Constants (PageSize, BufferPoolSize)
│   │   ├── rid.go               # Record Identifier
│   │   ├── channel.go           # Thread-safe channel
│   │   └── errors.go            # Error types
│   ├── storage/
│   │   ├── disk/                # Disk I/O layer
│   │   │   ├── disk_manager.go  # Read/write pages
│   │   │   └── disk_scheduler.go # Async I/O (Assignment 1)
│   │   ├── page/                # Page layouts
│   │   │   ├── page.go          # Base utilities
│   │   │   ├── table_page.go    # Table page (slotted)
│   │   │   ├── b_plus_tree_page.go # B+ tree pages
│   │   │   └── extendible_htable_page.go # Hash table pages
│   │   ├── index/               # Index structures
│   │   │   ├── index.go         # Index interface
│   │   │   ├── b_plus_tree.go   # B+ Tree (Assignment 2)
│   │   │   └── index_iterator.go # Iterator
│   │   └── table/               # Table storage
│   │       └── table_heap.go    # Table heap & tuple
│   ├── buffer/                  # Buffer pool
│   │   ├── replacer.go          # Replacer interface
│   │   ├── lru_k_replacer.go    # LRU-K (Assignment 1)
│   │   ├── page.go              # In-memory page
│   │   ├── frame_header.go      # Frame metadata
│   │   ├── page_guard.go        # RAII guards
│   │   └── buffer_pool_manager.go # BPM (Assignment 1)
│   ├── container/
│   │   └── hash/
│   │       └── extendible_hash_table.go # Hash table (Assignment 2)
│   ├── catalog/                 # Metadata
│   │   └── catalog.go           # Schema, tables, indexes
│   ├── types/                   # Type system
│   │   └── value.go             # TypeID, Value
│   ├── execution/               # Query execution
│   │   ├── executor.go          # Executor interface
│   │   └── executors/           # All executors (Assignment 3)
│   │       ├── scan_executors.go
│   │       ├── modification_executors.go
│   │       ├── join_executors.go
│   │       └── aggregate_sort_executors.go
│   ├── concurrency/             # Concurrency control
│   │   ├── transaction.go       # Transaction & MVCC (Assignment 4)
│   │   └── lock_manager.go      # Lock-based CC
│   └── recovery/                # Crash recovery
│       └── log_recovery.go      # WAL & ARIES
├── test/                        # Test files
│   ├── buffer/
│   │   └── buffer_pool_test.go
│   ├── index/
